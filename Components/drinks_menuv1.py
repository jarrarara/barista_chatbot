...
#print ("How many drinks would you like to order o(〃＾▽＾〃)o? ")
#num_drink = int(input())

for count in range (num_drinks):
    print(count, drink_names[count], drink_prices[count]) #prints the drinks names and the drink price together